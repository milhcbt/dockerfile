Nginx 1.6.2 + PHP 5.6 + PHP Composer Image from Modified Base Image of Debian (8.9). This image is ready to run using custom User ID with non-root user execution for OpenShift ready.
