Apache 2.4 + PHP 5.6 + PHP Composer Image from Modified Base Image of Ubuntu (16.04). This image is ready to run using custom User ID with non-root user execution for OpenShift ready.
