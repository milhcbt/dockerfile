Apache 2.4 + PHP 5.6 + PHP Composer Image from Modified Base Image of CentOS (7.3). This image is ready to run using custom User ID with non-root user execution for OpenShift ready.
